...
This project started for two purposes: (1) to practice good software developer practices as a training tool, and (2) to answer the question "what do we want to eat for dinner today?". Meals are generated by API calls to OpenAI and this project is currently on pause as I don't want to pay for this use case.
